...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(productDetails('oi', 'tchau')[0].details.productId.endsWith('123'), true);
    assert.strictEqual(productDetails('oi', 'tchau')[1].details.productId.endsWith('123'), true);
  });
});
