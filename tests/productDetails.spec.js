...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(productDetails('Alcool gel', 'Máscara')[0].details.productId.split('').reverse().join('').indexOf('321'), productDetails('Alcool gel', 'Máscara')[1].details.productId.split('').reverse().join('').indexOf('321'));
  });
});
