...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(produtos[0] === produtos[1], false);
    // (Difícil) Teste que os dois productIds terminam com 123.
    assert.strictEqual(produtos[0].details.productId.endsWith('123'), true);
    assert.strictEqual(produtos[1].details.productId.endsWith('123'), true);
  });
});
