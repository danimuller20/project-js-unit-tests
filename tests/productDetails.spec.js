...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual((/123\b/).test(productDetails('Alcool gel', 'Máscara')[0].details.productId), true);
    assert.deepStrictEqual((/123\b/).test(productDetails('Alcool gel', 'Máscara')[1].details.productId), true);
  });
});
