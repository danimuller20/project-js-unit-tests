...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(productDetails('Papel Higienico', 'Agua').length, 2);
    ...
    const product1 = productDetails()[0].details.productId;
    const product2 = productDetails()[1].details.productId;
    assert.strictEqual(product1.endsWith('123'), true);
    assert.strictEqual(product2.endsWith('123'), true);
  });
});
