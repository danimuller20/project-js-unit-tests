...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(productDetails('Alcool gel', 'Máscara')[0].details.productId.search(/\d/), 10);
    assert.strictEqual(productDetails('Alcool gel', 'Máscara')[1].details.productId.search(/\d/), 7);
  });
});
