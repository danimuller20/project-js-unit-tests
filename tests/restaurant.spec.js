...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepStrictEqual(createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}}).fetchMenu, objetoRetornado.fetchMenu);
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 5: Verifique que chamar uma função associada à chave `ord(er` no objeto retornado, passando uma string como parâmetro, como `objetoRetornado.order('coxinha')`, tal string é adicionada ao array retornado em `objetoRetornado.consumption
    // ```;
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 6: Verifique que as três orders seguintes, de bebidas e comidas mescladas, somam três itens no array `objetoRetornado1.consumption` conforme os itens pedidos.
    // ```
    // objetoRetornado1.order('coxinha');
    objetoRetornado1.order('agua');
    objetoRetornado1.order('sopa');
    objetoRetornado1.order('sashimi');
    // objetoRetornado1.consumption // Retorno: ['coxinha', 'agua', 'sopa', 'sashimi']
    // ```
    ...
    // ```
    const objetoRetornado3 = createMenu({food: {coxinha: 5.00}, drink: {agua: 2.50}});
    ...
    // ```
    assert.deepStrictEqual(Number(objetoRetornado3.pay().toPrecision(4)), 16.50);
