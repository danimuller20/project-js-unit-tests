...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const menu1 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} })
    assert.strictEqual(typeof menu1.fetchMenu , 'object');
    // ```
    ...
    // assert.strictEqual(Object.keys(objetoRetornado.fetchMenu).length === 2 && Object.keys(objetoRetornado.fetchMenu)[0] !== 'food' && Object.keys(objetoRetornado.fetchMenu)[1] !== 'drink', false);
    ...
    // ```
    assert.strictEqual(createMenu({ food: {}, drink: {} }).fetchMenu.toString(), objetoRetornado.fetchMenu.toString());
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    assert.deepStrictEqual(Object.keys(objetoRetornado.consumption), []);
    // --------------------------------------------------------------------------------------
    ...
    objetoRetornado.order('coxinha');
    assert.strictEqual(objetoRetornado.consumption.toString(), [ 'coxinha' ].toString());
    // --------------------------------------------------------------------------------------
    ...
    // ```
    assert.strictEqual(objetoRetornado.consumption.toString(), [ 'coxinha', 'agua', 'sopa', 'sashimi' ].toString());
    ...
    // ```
    assert.strictEqual(objetoRetornado.consumption.toString(), [ 'coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua', 'coxinha' ].toString());
