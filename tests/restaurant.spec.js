...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(Object.keys(objetoRetornado.fetchMenu()), ['food', 'drink']);
    ...
    // ```
    aassert.strictEqual(objetoRetornado.fetchMenu(), { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    assert.strictEqual(objetoRetornado.order('coxinha'), [objetoRetornado.consumption[1]]);
    // ```
    ...
    assert.strictEqual(objetoRetornado.consumption, ['coxinha', 'agua', 'coxinha']);
