...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let testObj = createMenu({});
    assert.deepStrictEqual( testObj, { fetchMenu: {}});
    // ```
    ...
    testObj = createMenu({ food: {}, drink: {} });
    assert.deepStrictEqual( testObj.fetchMenu, { food: {}, drink: {} });
    // ```
    ...
    // ```
    testObj = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    assert.deepStrictEqual(testObj.fetchMenu, { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```
    testObj.consumption = [];
    assert.deepStrictEqual(testObj.consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
