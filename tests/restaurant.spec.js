...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    const objMenu = {
      food: { 'coxinha': 3.90, 'sanduiche': 9.90, 'sashimi': 32.90, 'sopa': 10 },
      drinks: { 'agua': 3.90, 'cerveja': 6.90 },
    };
    ...
    assert.deepStrictEqual(returnedObj.consumption, []);
    ...
    assert.deepStrictEqual(returnedObj.consumption, ['coxinha']);
    ...
    assert.deepStrictEqual(returnedObj.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique que a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    // Agora faça o TESTE 8 deste arquivo.
    returnedObj.order('coxinha');
    returnedObj.order('agua');
    assert.deepStrictEqual(returnedObj.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua']);
    // --------------------------------------------------------------------------------------
    // TESTE 8: Verifique que, ao chamar `objetoRetornado.pay()`, retorna-se a soma dos preços de tudo que foi pedido, conforme registrado em `objetoRetornado.consumption`
    assert.deepStrictEqual(returnedObj.pay(), 58.50);
