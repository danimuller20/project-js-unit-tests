...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const returnObject = createMenu(anyObject);
    assert.deepStrictEqual(returnObject.fetchMenu, { food: {}, drink: {} });
    ...
    // ```
    assert.deepStrictEqual(returnObject.fetchMenu, anyObject);
