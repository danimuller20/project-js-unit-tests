...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual({ food: {}, drink: {} }, returnedObject.fetchMenu);
    ...
    assert.deepStrictEqual(returnedObject.consumption, ['coxinha', 'agua', 'sopa']);
    ...
    returnedObject.order('coxinha');
    returnedObject.order('agua');
    assert.deepStrictEqual(returnedObject.consumption, ['coxinha', 'agua', 'sopa', 'coxinha', 'agua']);
    ...
    returnedObject.order('coxinha');
    returnedObject.order('agua');
    assert.deepStrictEqual(returnedObject.pay(), 25.5);
