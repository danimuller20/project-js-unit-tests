...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.checkForDuplicates(objetoRetornado.consumption), true);
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado.pay(objetoRetornado.consumption), '12.87');
