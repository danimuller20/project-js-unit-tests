...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    delete objetoRetornado1.consumption;
    delete objetoRetornado1.order;
    delete objetoRetornado1.pay;
    assert.deepStrictEqual(objetoRetornado1, { fetchMenu: {} });
    ...
    const objetoRetornado2 = createMenu(menu);
    ...
    assert.deepStrictEqual(objetoRetornado3.fetchMenu, menu);
    ...
    const objetoRetornado5 = createMenu(menu);
    ...
    const objetoRetornado6 = createMenu(menu);
    ...
    const objetoRetornado7 = createMenu(menu);
    ...
    const fullMenu = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    const objetoRetornado8 = createMenu(fullMenu);
    objetoRetornado8.order('coxinha');
    objetoRetornado8.order('agua');
    objetoRetornado8.order('coxinha');
    sumOfPricesOfOrderAddingTip = objetoRetornado8.pay();
    assert.deepStrictEqual(objetoRetornado8.pay(), sumOfPricesOfOrderAddingTip);
