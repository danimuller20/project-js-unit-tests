...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let menu = createMenu(objectPassedByParameter);
    let fetchResult = menu.fetchMenu();

    assert.deepStrictEqual(typeof fetchResult, 'object');
    //--------------------------------------------------------------------------
    ...
    /* menu = createMenu(objectPassedByParameter);
    fetchResult = menu.fetchMenu(); */
    const verifyObjKeys = () => Object.keys(fetchResult);

    assert.deepStrictEqual(verifyObjKeys(), ['food', 'drink']);
    ...
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu // Retorno: objetoPassadoPorParametro 
    // ```
    
    assert.deepStrictEqual(fetchResult, objectPassedByParameter);
    ...
    // ```
    menu.order('coxinha');
    assert.deepStrictEqual(menu.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
