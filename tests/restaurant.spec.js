...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // `fetchMenu` deve ser uma função que retorna o `objetoQualquer`
    // ```
    ...
    // ```
    assert.deepStrictEqual(Object.keys(createMenu({ food: {}, drink: {} }).fetchMenu()), Object.keys({ food: {}, drink: {} }));
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado.consumption, ['coxinha', 'agua', 'sopa', 'coxinha', 'agua']);
