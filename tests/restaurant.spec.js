...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    let menuObj = createMenu({ food: {}, drink: {} });
    ...
    // ```
    assert.deepStrictEqual(menuObj.fetchMenu, { food: {}, drink: {} });
    ...
    // ```
    assert.deepStrictEqual({ food: {}, drink: {} }, menuObj.fetchMenu);
    ...
    assert.deepStrictEqual(menuObj.consumption, ['coxinha']);
    ...
    // ```
    assert.deepStrictEqual(menuObj.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
    ...
    // ```
    menuObj = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    menuObj.order('coxinha');
    menuObj.order('agua');
    menuObj.order('sopa');
    menuObj.order('cerveja');
    menuObj.order('coxinha');
    assert.deepStrictEqual(menuObj.pay(), 28.5);
