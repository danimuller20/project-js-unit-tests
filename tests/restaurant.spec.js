...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const entries = Object.entries(objetoRetornado)
    assert.deepStrictEqual(entries[0], ['fetchMenu', { food: {}, drink: {} } ]);
    ...
    assert.deepStrictEqual(myMenu, objetoRetornado.fetchMenu);
    ...
    objetoRetornado.order('sopa');
    objetoRetornado.order('sashimi');
    const arrayEsperado = [ 'coxinha', 'agua', 'sopa', 'sashimi' ]
    assert.deepStrictEqual(objetoRetornado.consumption, arrayEsperado);
    ...
    // ```
    objetoRetornado.order('sashimi');
    const arrayEsperado2 = [ 'coxinha', 'agua', 'sopa', 'sashimi', 'sashimi' ]
    assert.deepStrictEqual(objetoRetornado.consumption, arrayEsperado2);
    ...
    const objetoRetornado2 = createMenu(myNewMenu);
    objetoRetornado2.order('coxinha');
    objetoRetornado2.order('refrigerante');
    objetoRetornado2.order('coxinha');
    ...
    const valorEsperado = 58;
    assert.strictEqual(objetoRetornado2.pay(),valorEsperado);
