...
const menu = require('../src/restaurant');
...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const bill = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    assert.deepStrictEqual(menu.createMenu(bill), { fetchMenu: bill });
    ...
    // ```
    const objetoRetornado = menu.createMenu({ food: {}, drink: {} });
    ...
    // ```
    const objetoRetornado2 = menu.createMenu(bill);
    assert.deepStrictEqual(objetoRetornado2.fetchMenu, bill);
    ...
    // ```
    menu.addConsumption(objetoRetornado2);
    ...
    // ```
    menu.orderFromMenu(objetoRetornado2);
    ...
    // ```
    menu.addConsumption(objetoRetornado);
    menu.orderFromMenu(objetoRetornado);
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    ...
    // ```
    const objetoRetornado3 = menu.createMenu(bill);
    menu.addConsumption(objetoRetornado3);
    menu.orderFromMenu(objetoRetornado3);
    objetoRetornado3.order('coxinha');
    objetoRetornado3.order('agua');
    objetoRetornado3.order('coxinha');
    menu.priceTag(objetoRetornado3);
    assert.strictEqual(objetoRetornado3.pay(), 12.87);
