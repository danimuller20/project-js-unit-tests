...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const actual = { food: { 'coxinha': 3.90, 'sanduiche': 9.90 }, drinks: { 'agua': 3.90, 'cerveja': 6.90 } };
    const objetoRetornado = createMenu(actual);
    ...
    //assert.deepStrictEqual(createMenu({food: {pastel: 10.5}, drink: {coca: 5.5}}).fetchMenu, {food: {pastel: 10.5}, drink: {coca: 5.5}});
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    //assert.deepStrictEqual(createMenu({food: {pastel: 10.5}, drink: {coca: 5.5}}).consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // const objetoRetornado = createMenu(objetoQualquer);
    //otherObject = createMenu({food: {pastel: 10.5}, drink: {coca: 5.5}});
    //otherObject.order("coxinha")
    // objetoRetornado.comsuption // Retorno: ["coxinha"]
    //assert.deepStrictEqual(otherObject.consumption, ['coxinha']);
