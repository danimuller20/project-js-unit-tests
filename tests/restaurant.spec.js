...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.ok(Object.entries(createMenu('object')), {'fetchMenu': 'object'});
    ...
    assert.ok(Object.keys(createMenu({ food: {}, drink: {}}).fetchMenu), ['drink', 'food']);
    ...
    assert.ok(createMenu({ food: {}, drink: {}}).fetchMenu,{ food: {}, drink: {}});
    ...
    assert.ok(createMenu({ food: {}, drink: {}}).consumption, []);
    ...
    assert.ok((pedido('coxinha')).order, 'coxinha');
    assert.ok(pedido('coxinha').consumption[0], 'coxinha');
