...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.notDeepStrictEqual(typeof createMenu('Coxinha'), undefined);
    ...
    assert.deepStrictEqual(createMenu('objQualquer').fetchMenu, 'objQualquer');
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    assert.deepStrictEqual(createMenu('objetoQualquer').comsuption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    function verify6() {
      ...
      assert.deepStrictEqual(objetoRetornado.comsuption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    };
    verify6();
    // objetoRetornado.order("coxinha");
    // objetoRetornado.order("agua");
    ...
    function verify8() {
      const objetoRetornado = createMenu({
         food: { coxinha: 1.00, sopa: 2.00, sashimi: 3.00},
         drink: { agua: 4.00, cerveja: 5.00},
      });
      objetoRetornado.order('coxinha');
      objetoRetornado.order('sopa');
      objetoRetornado.order('sashimi');
