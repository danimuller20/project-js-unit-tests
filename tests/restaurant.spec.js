...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(menu1.fetchMenu, {});
    ...
    menu2.order('coxinha');
    assert.deepStrictEqual(menu2.consumption, ['coxinha']);
    ...
    menu3.order('sopa');
    menu3.order('sashimi');
    assert.deepStrictEqual(menu3.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    menu4.order('agua');
    menu4.order('coxinha');
    assert.deepStrictEqual(menu4.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    menu5.order('agua');
    menu5.order('coxinha');
    assert.deepStrictEqual(menu5.pay(menu5), 11.7);
