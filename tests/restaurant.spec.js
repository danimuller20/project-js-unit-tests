...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    const myMenu = {
      food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 13},
      drink: {'agua': 3.9},
    };
    ...
    // ```
    // assert.strictEqual(createMenu(anyObject), { fetchMenu: anyObject });
    ...
    // ```
    const returnObject = createMenu(myMenu);
    assert.deepStrictEqual(returnObject.fetchMenu, {
      food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 13},
      drink: {'agua': 3.9},
    });
    ...
    // ```
    assert.deepStrictEqual(returnObject.fetchMenu, myMenu);
    ...
    // ```
    assert.deepStrictEqual(returnObject.consumption, []);
    ...
    returnObject.order('agua');
    returnObject.order('coxinha');
    assert.deepStrictEqual(returnObject.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua', 'coxinha']);
    ...
    // ```
    const returnObject2 = createMenu(myMenu);
    returnObject2.order('coxinha');
    returnObject2.order('agua');
    returnObject2.order('coxinha');
    assert.deepStrictEqual(returnObject2.pay(), 12.87);
