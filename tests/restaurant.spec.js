...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // assert.deepStrictEqual(objeto.fetchMenu, {});
    // ```
    ...
    // assert.deepStrictEqual(objeto.consumption, []);
    // ```
    ...
    // ```;
    // const objetoEsperado = createMenu({ food: {'coxinha': 3.90} });
    // objetoEsperado.order('coxinha');
    // objetoRetornado.comsuption // Retorno: ["coxinha"]
    // assert.deepStrictEqual(objetoEsperado.consumption, ['coxinha']);
    // ```
    ...
    // ```
    // objetoEsperado.order('coxinha');
    // objetoEsperado.order('agua');
    // objetoEsperado.order('sopa');
    // objetoEsperado.order('sashimi');
    ...
    // assert.deepStrictEqual(objetoEsperado.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua', 'coxinha']);
    // ```
    // Agora faça o TESTE 8 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 8: Verifique que, ao chamar `objetoRetornado.pay()`, retorna-se a soma dos preços de tudo que foi pedido, conforme registrado em `objetoRetornado.consumption`
    // ```
    const objetoRetornado = createMenu({ food: {'coxinha': 3.90}, drinks: {'agua': 2.50} });
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.strictEqual(objetoRetornado.pay(), 10.30); // Retorno: somaDosPreçosDosPedidos
    // ```
