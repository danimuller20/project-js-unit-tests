...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objetoRetornado0 = createMenu({});
    assert.deepStrictEqual(typeof objetoRetornado0, 'object');
    ...
    // ```
    assert.deepStrictEqual(createMenu(Object({ food: {}, drink: {} })).fetchMenu, {'food': {}, 'drink': {}});
    ...
    // ```
    assert.deepStrictEqual(createMenu({}).order('coxinha'), createMenu({}).consumption[0]);
    ...
    // ```
    const objetoRetornado3 = createMenu({ food: {'coxinha': 4.90, 'hamburguer': 10.00}, drink: {'agua': 2.00, 'refri': 4.00}});
    objetoRetornado3.order('coxinha');
    objetoRetornado3.order('agua');
    objetoRetornado3.order('hamburguer');
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    // ```
    assert.strictEqual(objetoRetornado3.pay(), 18.59);
