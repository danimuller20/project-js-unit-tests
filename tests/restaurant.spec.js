...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    assert.deepStrictEqual(Object.entries(createMenu({ food: {}, drink: {} }))[0], [ 'fetchMenu', { food: {}, drink: {} } ]);
    ...
    // ```
    assert.deepStrictEqual(createMenu().order('pastel'), Object.values(createMenu()).consumption);
    ...
    // ```
    assert.strictEqual(createMenu().pagamento(), 6.5);
