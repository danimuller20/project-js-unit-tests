...
/*
  ...
  Deve ser possível, através desse sistema, cadastrar um menu. Dado que um menu foi
  cadastrado, o sistema deve disponibilizar um objeto através do qual se consegue:
  ...
  - Uma chave `fetchMenu` retorna o objeto que a função `createMenu` recebe por
  parâmetro. O menu tem sempre duas chaves, `food` e `drink`, no seguinte formato:
...
// PASSO 3: Crie uma função, separada da função `createMenu()`, que, dada uma string
// recebida por parâmetro, adiciona essa string ao array de `objetoRetornado.
// consumption`. Adicione essa função à chave `order`.
