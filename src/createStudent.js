...
// quando uma arrow function tem só um param podemos tirar os parenteses; quando
// a função retorna somente um objeto o objeto deve ficar dentro de parenteses;
